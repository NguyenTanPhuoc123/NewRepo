   ...
   public class BillMenu
    {
        ...
        public BillMenu(string iD, string dayCheckIn, string dayCheckOut, int employeeID, string employeeName, string customerID, string customerName, string discountID, string discountName, int tableID, string tableName, bool statusCheckOut)
        {
            m_ID = iD;
        ...
        public BillMenu(DataRow row)
        {
            ...
            this.m_CustomerName = row["TENKH"].ToString();
